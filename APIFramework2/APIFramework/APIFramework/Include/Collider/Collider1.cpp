...
bool CCollider1::CollisionRectToRect(const RECTANGLE & src, const RECTANGLE & dest)
{
	if (src.l > dest.r)
		return false;
...
bool CCollider1::CollisionRectToSphere(const RECTANGLE & src, const SPHERE & dest)
{
...
bool CCollider1::CollisionSphereToSphere(const SPHERE & src, const SPHERE & dest)
{
...
bool CCollider1::CollisionRectToPixel(const RECTANGLE & src, const vector<PIXEL>& vecPixel, int iWidth, int iHeight)
{
	m_tHitPoint.x = -1;
	m_tHitPoint.y = -1;
...
bool CCollider1::CollisionSphereToPixel(const SPHERE & src, const vector<PIXEL>& vecPixel, int iWidth, int iHeight)
{
	return false;
}

bool CCollider1::CollisionRectToPoint(const RECTANGLE & src,
	const POSITION & dest)
{
	if (dest.x < src.l)
		return false;
...
bool CCollider1::CollisionSphereToPoint(const SPHERE & src,
	const POSITION & dest)
{
	return CMath::Distance(dest, src.tCenter) <= src.fRadius;
}

bool CCollider1::CollisionPixelToPoint(const vector<PIXEL> vecPixel, int iWidth, int iHeight, const POSITION & dest)
{
...
bool CCollider1::Collision(CCollider1* pDest)
{
	return false;
}
